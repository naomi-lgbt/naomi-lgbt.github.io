...
(async () => {
    ...
    const adventuresPath = join(process.cwd(), "src", "assets", "data", "adventures.ts");
    ...
    const artPath = join(process.cwd(), "src", "assets", "data", "portraits.ts");
    ...
    const emotesPath = join(process.cwd(), "src", "assets", "data", "emotes.ts");
